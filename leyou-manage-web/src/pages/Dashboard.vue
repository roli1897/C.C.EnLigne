    ...
    mounted(){
      this.$nextTick(() => {
        ...
        var option = {
          ...
          tooltip: {},
          legend: {
            data:['Volume de ventes']
          },
          xAxis: {
            data: ["Chemise","Pull","Chemisier","Pantalon","Talons hauts","Chaussettes"]
          },
          yAxis: {},
          series: [{
          ...
          series : [
            {
              ...
              radius: '55%',
              data:[
                {value:235, name:'Publicité vidéo'},
                {value:274, name:'Publicité en affiliation'},
                {value:310, name:'Marketing par e-mail'},
                {value:335, name:'Accès direct'},
                {value:400, name:'Moteur de recherche'}
              ]
            }
          ],
          itemStyle: {
